...
class FakeBackbone(nn.Module):
    ...
    def __init__(self, C=4, H=512, W_=16, T_raw=1024):
        ...
        # No freq / seasonality embedding, no patch stats — the strategies
        # tests only care about the patching/transformer interaction.
...
def _make_mock_backbone():
    ...
    class MockTransformer(nn.Module):
        ...
        def forecaster_forward(self, x, fp32_tail=True, cache_mask=True):
            ...
            # so neither the precision policy nor the mask has anything to
            # act on.
            del fp32_tail, cache_mask
