...
| B2 | 200k | 1.2904 | 1.1850 | +0.1054 | 1.2825 | — | — |
...
| B6 | 200k | 1.2207 | 1.3011 | -0.0804 | 1.2339 | — | — |
...
34 of 42 (cell, stop) pairs measured. `S` is the student-encoder head, `T` the teacher-encoder head. A `—` in a `k = 0` column means the parent report published no such number: group B's two parents publish the student head only, so a group-B teacher row carries a value and no delta.
...
| A3 | 200k | no | — | ceiling: 200k is the card's last stop (S +0.0988) |
...
| B2 | 200k | no | student, teacher | ceiling: 200k is the card's last stop (S -0.0539, T -0.0292) |
...
| B6 | 200k | no | — | ceiling: 200k is the card's last stop (S +0.0056, T +0.0229) |
...
| B10 | 200k | no | teacher | ceiling: 200k is the card's last stop (S +0.0221, T -0.0059) |
