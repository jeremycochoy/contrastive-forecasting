...
cf401_require_head_steps "$HEAD_STEPS" || exit $?
...
# study's root; CF_STUDY_DIR places the score file and the log in this
# study's results/.
CF373_ROOT="$CF401_ROOT" CF_STUDY_DIR="$CF401_STUDY" WT="$CF401_WT" \
  BB_GPU="$BB_GPU" \
