...
![Per-arm h_t drift trajectory, one value per adjacent 5k-step checkpoint pair, drift_cos_h in [0,2] on a linear y-axis, log training step on x. One panel per arm; black dashed line at drift = 1 for scale reference.](plots/latent_movement_per_arm.png)
