...
# from 0.1 to 1.0. Versus #355's launch script
# (experiments/2026-06-20_lejepa_sigreg/scripts/train_backbone_sigreg.sh),
# one change: λ_e=λ_h=0.1 ->
...
log "BB START arm=sigreg-enc3 bs=512 steps=$STEPS xshh_chunk=$XSHH_ALLT_CHUNK cpc_chunk=$CPC_CB_CHUNK ${RESUME}"
