...
The convolution is motivated by the analysis of induction
...
shallower attention than would otherwise be needed. This significantly
improves the performance of small transformers, the regime we operate
in.
