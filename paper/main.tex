...
multiplications that the GPU executes in parallel. The cross-temporal
candidates require one inner product per anchor. At every position
$(t, c)$ we aggregate the candidates of all anchors into three sums,
