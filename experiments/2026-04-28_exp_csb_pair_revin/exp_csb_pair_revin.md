...
Companion to `2026-04-28_exp_csb_pair_span512`. That experiment showed that, with
...
2. **EWMA span=512 beats RevIN under both losses.**
   ...
   Consistent with `2026-04-27_exp_span_sweep_synth`'s finding that span=512 is the
...
3. **The best single configuration of the four is EWMA span=512 + CSB
   ...
   `../2026-04-28_exp_csb_pair_span512/exp_csb_pair_span512.md`. Among the comparable
...
- Same eval script, same seed, same byte-identical SN baseline values
  ...
  every prior arm in `2026-04-27__aggregate/results/synth_eval.csv`.
