...
Covers four ablations run on top of the periodic-synth-mix baseline (see
[`../periodic-synth-mix/REPORT.md`](../periodic-synth-mix/REPORT.md)):
...
failure mode visible in the periodic-synth-mix prediction plots
([`../periodic-synth-mix/plots/predictions/`](../periodic-synth-mix/plots/predictions/)).
...
- **SN baseline only succeeded on 43 of 97 configs.** The local
  SN computation in `experiments/periodic-synth-mix/scripts/seasonal_naive_check.py`-style
