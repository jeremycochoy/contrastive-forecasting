...
- `experiments/2026-04-16_head-rollout-comparison/notes/DESIGN.md` — this document
...
- `experiments/2026-04-16_head-rollout-comparison/head-rollout-comparison.md` — comparison table (after experiments)
