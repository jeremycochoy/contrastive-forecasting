...
Outputs
-------
- experiments/periodic-synth-mix/plots/inspect_grid.png
    10x10 grid of series with primitive name + key params in title.
- experiments/periodic-synth-mix/plots/inspect_metadata.txt
    Per-series metadata + first/last/min/max/mean/std and a head/tail
    sample of values so I can read numbers (graphs are coarse).

Usage: python3.11 experiments/periodic-synth-mix/scripts/inspect_synth.py
"""
