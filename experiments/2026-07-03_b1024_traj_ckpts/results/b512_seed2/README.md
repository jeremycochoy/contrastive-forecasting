...
Both files extracted on 2026-07-10 from the in-flight #371 experiment
...
- `steps_loss.csv` — `step,loss`, legs base + r2 + r4 deduplicated on
  step, covering steps 1–49,300. B=512 reference curve for the
  report's backbone-loss plot.
- `gm.csv` — `head,step,gm`: GM-Rel MASE of every completed seed-2
  trajectory cell (steps 12,500–37,500 at extraction time). B=512
