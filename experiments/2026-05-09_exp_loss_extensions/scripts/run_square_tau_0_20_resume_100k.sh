#!/bin/bash
# Continue loss_ext_square_tau_0_20 from step 25000 to step 100000.
# Resume bundle: sync_loss_ext_square/checkpoints/loss_ext_square_tau_0_20_50k_25k.pth
# (latest periodic save from the aborted 50k extension run; companion
#  _optimizer.pth is loaded automatically from same dir).
#
# Long-trajectory variant. The original 50k extension was stopped at
# step 25000 to free the GPU for the τ=0.10 100k run; this script
# picks up where that left off and runs through to 100k.
...
NAME="loss_ext_square_tau_0_20_100k"
RESUME="${SAVE_DIR}/loss_ext_square_tau_0_20_50k_25k.pth"
...
echo "=== loss_ext_square τ=0.20 RESUME (from 25k) → 100k → ${NAME} ==="; date
