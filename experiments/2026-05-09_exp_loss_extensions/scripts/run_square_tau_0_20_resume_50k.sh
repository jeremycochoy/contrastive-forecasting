#!/bin/bash
# Continue loss_ext_square_tau_0_20 from step 15000 to step 50000.
set -e
...
NAME="loss_ext_square_tau_0_20_50k"
RESUME="${SAVE_DIR}/loss_ext_square_tau_0_20_15k.pth"
...
echo "=== loss_ext_square τ=0.20 RESUME → 50k → ${NAME} ==="; date
