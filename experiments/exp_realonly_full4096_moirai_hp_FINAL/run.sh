#!/bin/bash
# exp_realonly_full4096_moirai_hp_FINAL (#10) — final 1-epoch retrain of the
...
#     experiments/exp_realonly_full4096_learnable_tau/REPORT.md and
#     experiments/exp_realonly_full4096_learnable_tau/run.sh which both
...
RES_DIR="experiments/exp_realonly_full4096_moirai_hp_FINAL/results/gift_eval"
mkdir -p "$RES_DIR"
