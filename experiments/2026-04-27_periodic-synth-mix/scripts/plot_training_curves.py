...
Usage:
    python experiments/2026-04-27_periodic-synth-mix/scripts/plot_training_curves.py \\
        --ctrl sync_periodic_synth/checkpoints/tiny_v3c_ctrl_losses.csv \\
        --mix  sync_periodic_synth/checkpoints/tiny_v3c_mix_losses.csv \\
        --out  experiments/2026-04-27_periodic-synth-mix/plots/training_curves.png
"""
