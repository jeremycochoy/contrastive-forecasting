#!/usr/bin/env python3
"""Compare CONTROL vs MIX GIFT-Eval results for the 2026-04-27_periodic-synth-mix experiment.
...
- ``experiments/2026-04-27_periodic-synth-mix/results/comparison.txt`` — aggregate GM-Rel
...
- ``experiments/2026-04-27_periodic-synth-mix/results/periodic_datasets.txt`` — same
  tables restricted to the 6 "periodic" configs identified in HANDOFF.md.
- ``experiments/2026-04-27_periodic-synth-mix/plots/mase_compare.png`` — bar chart of the
  periodic datasets across all three arms.

Usage:
    python experiments/2026-04-27_periodic-synth-mix/scripts/compare_results.py \\
