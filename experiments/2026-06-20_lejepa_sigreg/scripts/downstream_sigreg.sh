#!/bin/bash
# #355 — downstream q-head + GIFT-Eval for the SIGReg-B=512 enc3+CPC backbone.
# Identical protocol to #353's downstream_ema.sh (the comparison must be
# head-matched against the #353 EMA-target arm and the #344 enc3+CPC baseline).
