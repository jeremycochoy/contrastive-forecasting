#!/bin/bash
# τ=0.20 resume — vast.ai single-arm launcher.
#
# Continue τ=0.20 from its 15k v2 FINAL.pth to 50,000 steps total on a fresh
# vast.ai DC 5090 on-demand instance, so we can compare its long-window
# trajectory against backbone-β_167k.
#
...
#   nohup bash experiments/2026-05-08_exp_tau_sweep/scripts/run_tau_0_20_resume_50k_vast.sh \
#       > /workspace/app/run_tau_0_20_50k.log 2>&1 &
#   disown
