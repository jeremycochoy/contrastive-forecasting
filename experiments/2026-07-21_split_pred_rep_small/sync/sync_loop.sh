...
# #379 no-sigreg-embedding reruns — `_nse_` marker in the NAME.
NAME_arm1_nse="bb_small_arm1_nse_split_pred_rep_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm3_nse="bb_small_arm3_nse_split_pred_rep_moco_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm4_nse="bb_small_arm4_nse_xshh_allt_moco_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm5_nse="bb_small_arm5_nse_lalign_lrep_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm6_v2_nse="bb_small_arm6_v2_nse_lalign_lrepmoco_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_bimoco_nse="bb_small_bimoco_nse_split_pred_rep_moco_bothsides_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
# #379 no-CPC reruns — `_ncpc_` marker in the NAME.
NAME_arm1_ncpc="bb_small_arm1_ncpc_split_pred_rep_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm3_ncpc="bb_small_arm3_ncpc_split_pred_rep_moco_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm4_ncpc="bb_small_arm4_ncpc_xshh_allt_moco_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm5_ncpc="bb_small_arm5_ncpc_lalign_lrep_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_arm6_v2_ncpc="bb_small_arm6_v2_ncpc_lalign_lrepmoco_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
NAME_bimoco_ncpc="bb_small_bimoco_ncpc_split_pred_rep_moco_bothsides_enc3l3_b64_200k_sigreg_ema_qk_aon_cpc_tau090"
...
while true; do
  ...
  # `orchestrate.log`; the #379 rerun sweeps each write to their own
  # `orchestrate_*.log`. safe_pull silently skips missing files, so
  # listing every possible orchestrator is fine even when only one has run.
  ...
  pull "$REMOTE_DIR/results/orchestrate_no_sigreg_e.log" "$LOCAL_DIR/results/orchestrate_no_sigreg_e.log" "$TEXT_MIN"
  pull "$REMOTE_DIR/results/orchestrate_no_cpc.log"      "$LOCAL_DIR/results/orchestrate_no_cpc.log"      "$TEXT_MIN"
  pull "$REMOTE_DIR/results/orchestrate_base_fresh.log"  "$LOCAL_DIR/results/orchestrate_base_fresh.log"  "$TEXT_MIN"
