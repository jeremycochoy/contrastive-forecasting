#!/usr/bin/env python3
"""Shard a GIFT-Eval full-97 run into N parallel processes (#341, cloned from
#339's shard_evals.py — same mechanics, sgcap paths).
...
of configs; see #339 notes/EXECUTION_LOG.md).
