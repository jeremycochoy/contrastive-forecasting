...
| [exp_csb_pair_span512](exp_csb_pair_span512/README.md) | Complete (single seed each) | Clean A/B retrain with matched `_best_loss` selector. CSB **0.883** vs no_time_neg **0.924**: CSB is **4.5% better** on MASE, 3.9% better on WQL — flips the original conclusion (selector + multi-resume confound). |
