...
| File | Description |
|------|-------------|
| **[technical_report.md](../contrastive-arma.md)** | **Start here.** Human-readable narrative of the full optimization process, with consolidated tables and figures. |
