...
experiments/2026-04-12_contrastive-arma/
  contrastive-arma.md  ← the report (start here)
  notes/               ← you are here
  plots/               ← figures
...
| File | Description |
|------|-------------|
| **[contrastive-arma.md](../contrastive-arma.md)** | **Start here.** Human-readable narrative of the full optimization process, with consolidated tables and figures. |
...
|----------|-------------|
| `gap_trajectories.ipynb` | Gap trajectory plots for scaling comparison (generates `gap_*.png` in plots/) |
