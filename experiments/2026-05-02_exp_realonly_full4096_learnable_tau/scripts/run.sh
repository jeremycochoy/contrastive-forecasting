#!/bin/bash
# 2026-05-02_exp_realonly_full4096_learnable_tau (#33 FINAL) — re-run the #27/#32
...
RES_DIR="experiments/2026-05-02_exp_realonly_full4096_learnable_tau/results/gift_eval"
mkdir -p "$RES_DIR"
