...
RUNS = [  # (label, attn_amplitude.csv, color)
    ...
    ("b1024 lr1e-3 +attn-out-only", f"{ROOT}/2026-05-29_forked_6Lf_b1024/runs/bb_beta_forked2_aon_6Lf_b1024_attn_amplitude.csv", "#17becf"),
    ("b1024 lr1e-3 +QK-norm+attn-out", f"{ROOT}/2026-05-29_forked_6Lf_b1024/runs/bb_beta_forked2_qk_aon_6Lf_b1024_attn_amplitude.csv", "#000000"),
]
