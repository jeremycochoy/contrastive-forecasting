#!/usr/bin/env python3
"""Merge sharded GIFT-Eval outputs into the canonical eval dir (#339).
...
sn = {}
ref = f"{EXP}/results/reference/gift_eval_full_allt08_xftrip_nobn_enc3_qk_aon_b1024_2L/summary.txt"
