...
PANELS = [
    ...
    ("+ CPC InfoNCE", "encoder depth",
     [("no-enc", "noenc_cpc", "C0"), ("enc-3", "cpc_enc3", "0.7"), ("enc-6", "cpc_enc6", "0.45")]),
...
def main():
    ...
    fig.suptitle("#348 No-encoder backbone — GIFT-Eval full-97 GM-Relative MASE", fontsize=13)
