...
Identical to
[`2026-05-02_exp_realonly_full4096_learnable_tau`](../2026-05-02_exp_realonly_full4096_learnable_tau/exp_realonly_full4096_learnable_tau.md)
...
report](../2026-05-02_exp_realonly_full4096_learnable_tau/exp_realonly_full4096_learnable_tau.md) for the
shared knob table.
...
side-by-side), see the 3-panel final figure
...
![3-panel final comparison of #6 (default HP) vs #9 (MOIRAI HP) over the full 30k — backbone contrastive loss, learnable-τ trajectory, and head loss on shared log-step axes](plots/full4096_3panel_final.png)
...
- **Companion run script** —
  `experiments/2026-05-02_exp_realonly_full4096_moirai_hp/scripts/run.sh`
...
hypothesis from §5 of the [#6 report](../2026-05-02_exp_realonly_full4096_learnable_tau/exp_realonly_full4096_learnable_tau.md):
...
- **#6 default-HP companion (DONE)**:
  [`experiments/2026-05-02_exp_realonly_full4096_learnable_tau/exp_realonly_full4096_learnable_tau.md`](../2026-05-02_exp_realonly_full4096_learnable_tau/exp_realonly_full4096_learnable_tau.md).
