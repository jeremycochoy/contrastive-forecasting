#!/bin/bash
# v17 JEPA q-head — 2L causal transformer q-head on v17's JEPA backbone
# (encoder=6L, forecaster=1L; --encoder-dropkey 0.95; NEW conv placement:
# --depthwise-conv 3, --deprecated-depthwise-conv 0; PURE fp32 body).
#
# Mirrors run_qhead_v15.sh exactly. Only differences:
#   • backbone path = v17 FINAL (50k fresh)
#   • run name = enc_fcst_v17_qhead_xfmr2L_quant_30k
#   • GPU 1 default (v16 occupies GPU 0)
#   • Backbone-load flags reflect v17: --num-layers 1 (forecaster=1L)
#
# Qhead arch + training UNCHANGED.
#
# Compare triage GM-MASE to v11c (1.388), v14 (1.650), v15 (1.671).
...
echo "=== START $RUN_NAME (2L qhead on v17 JEPA backbone, GPU=$CUDA_VISIBLE_DEVICES) ===" && date
