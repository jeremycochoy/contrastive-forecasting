#!/bin/bash
# v16 JEPA q-head — 12L causal transformer q-head (best q-head proven on v7) on v16's JEPA backbone.
# v11c is the current best JEPA backbone (vs 0.9 in v11c) at
...
echo "=== START $RUN_NAME (12L qhead on v11c JEPA backbone, fcst=1L, dk=0.9) ===" && date
