#!/bin/bash
# v11c — same as v11/v11b but fp16 body (resid+attn+ffn fp16, pemb fp32) — v11c recipe + dropkey 0.8 + FFN-fp16 (rest fp32), fresh init — dropkey sweep point + ffn-fp16 stability across the whole transformer body
...
NAME="enc_fcst_v27_dk08_ffnfp16_50k"
...
echo "=== START ${NAME} (fresh, JEPA 6L+1L, new conv, fp16 body (resid+attn+ffn fp16, pemb fp32) — v11c recipe + dropkey 0.8 + FFN-fp16 (rest fp32), fresh init — dropkey sweep point + ffn-fp16 stability) ===" && date
