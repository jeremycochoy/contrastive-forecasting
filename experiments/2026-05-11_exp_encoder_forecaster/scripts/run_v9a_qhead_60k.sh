#!/bin/bash
# v9a — extend v7's q-head from 30k to 60k. R9_E13's original recipe
# was 60k; the 30k cut was a previous compromise. v7 q-head 30k landed
# best ema_loss=0.275 / triage GM-MASE=1.512 (gate fail). Test whether
# more head training drops MASE.
#
# Same backbone as v7 q-head: enc_fcst_dk09_hsl_b256_fp32_50k_FINAL.pth.
# Same recipe (R9_E13 + bf16, e_then_f, Moirai HP, cosine + 2k warmup).
# Only --total-steps changes 30000 → 60000 (so cosine decay also stretched).
# GPU 0.
...
RUN_NAME="enc_fcst_v7_qhead_xfmr12L_quant_60k"
