#!/bin/bash
# v11c — same as v11/v11b but fp16 body (resid+attn+ffn fp16, pemb fp32) — fresh-init fp16 retest of v11c recipe across the whole transformer body
...
NAME="enc_fcst_v18_v11c_recipe_fp16body_50k"
...
echo "=== START ${NAME} (fresh, JEPA 6L+1L, new conv, fp16 body (resid+attn+ffn fp16, pemb fp32) — fresh-init fp16 retest of v11c recipe) ===" && date
