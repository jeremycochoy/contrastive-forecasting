#!/bin/bash
# v11c — same as v11/v11b but PURE fp32 across the whole transformer body
...
NAME="enc_fcst_v11c_jepa_newconv_fp32_50k"
...
echo "=== START ${NAME} (fresh, JEPA 6L+1L, new conv, PURE fp32) ===" && date
