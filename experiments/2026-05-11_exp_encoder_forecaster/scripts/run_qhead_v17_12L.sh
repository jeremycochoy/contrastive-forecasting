#!/bin/bash
# v17 JEPA q-head — 12L causal transformer q-head (best q-head proven on v7) on v17's JEPA backbone.
# v17 differs from v11c only by --encoder-dropkey 0.7 (vs 0.9 in v11c) at
...
echo "=== START $RUN_NAME (12L qhead on v17 JEPA backbone, fcst=1L, dk=0.95) ===" && date
