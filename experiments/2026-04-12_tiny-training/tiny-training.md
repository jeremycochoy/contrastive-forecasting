...
| File | Description |
|---|---|
| [INCIDENT_NAN_AND_RESUME.md](notes/INCIDENT_NAN_AND_RESUME.md) | Root cause analysis of NaN crash at step 24,970 (all-NaN row in HF data) and discovery of incomplete checkpoint resume state. Documents the harmful zero-fill intermediate fix and the correct skip-row solution. |

## Training Dashboard

![Training dashboard](plots/training_dashboard.png)

## NaN Crash Analysis

![Crash analysis](plots/crash_analysis.png)
