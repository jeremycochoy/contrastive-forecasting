#!/bin/bash
# Atomic sync loop for one arm of exp_compositesynth_v5envboost_2arm.
# Mirrors sync_compositesynth_v2pulse/sync_loop.sh but with v2b run-name
# pattern (tiny_compsyn_v5_<arm>) and v2b experiment dir.
...
REMOTE_RESULTS_DIR="/workspace/app/experiments/exp_compositesynth_v5envboost_2arm/results"
REMOTE_LOG="/workspace/app/run_${ARM}.log"
LOCAL_BASE="/Users/jeremycochoy/Desktop/workspace/trading/contrastive-forecasting/sync_compositesynth_v5envboost/${ARM}"
